...
n_s = 14 #global defining number of state
n_t = 15 #global defining number of events per location
n_a = 17 #global defining number of age categories
n_wa = 20 #global defining number of wider area groupings
n_ta = 15 #global defining number of events per location and age group
