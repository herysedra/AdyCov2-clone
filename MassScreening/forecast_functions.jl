...
function run_simulations(P::KenyaCoV_MS.CoVParameters_AS,prob,n_traj,τ,ϵ_D,cb)
    P.τ_initial = τ
    P.ϵ_D = ϵ_D
...
function run_scenario(P::KenyaCoV_MS.CoVParameters_AS,prob,n_traj,treatment_rates,cb)
    results = []
